...
- [x] Add focused unit tests for prompts, storage compatibility, runtime profiles, request lifecycle and serialization, protocol bounds, image validation, and generated Webview behavior; 48 automated tests pass. Manual Extension Host checks remain unavailable in this non-interactive run.
