...
- [x] Add focused unit tests for prompts, storage compatibility, runtime profiles, request serialization, protocol bounds, image validation, and generated Webview behavior; 43 automated tests pass. Manual Extension Host checks remain unavailable in this non-interactive run.
