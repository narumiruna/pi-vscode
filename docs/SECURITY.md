...
The standalone PiCode bridge extension is installed globally and executes with the user's permissions.
...
Focused editor edits enter the persistent PiCode Chat session as edit proposals.
